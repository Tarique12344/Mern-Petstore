      ...
      <Container style={{ marginTop: '30px' }}>
        ...
        <Carousel>
          ...
          <Carousel.Item>
            <img
              className="d-block w-100"
              src={pictureData[1].src}
              alt={`Slide ${pictureData[1].id}`}
              height="80"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="d-block w-100"
              src={pictureData[2].src}
              alt={`Slide ${pictureData[2].id}`}
              height="80"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="d-block w-100"
              src={pictureData[3].src}
              alt={`Slide ${pictureData[3].id}`}
              height="80"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="d-block w-100"
              src={pictureData[4].src}
              alt={`Slide ${pictureData[4].id}`}
              height="80"
            />
          </Carousel.Item>
