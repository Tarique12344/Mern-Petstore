          ...
          <br></br>
            ...
            <div className="row text">
              ...
              <div className="col-md-6">
                ...
                <p>
                  (Whatever this place will be called) vows to never bow to the yoke of capitalism and is run solely on donations. If your business wants to make a <a href='Donation'>donation</a>, We'll feature you in our newsletter!
                </p>
              </div>
            </div>
